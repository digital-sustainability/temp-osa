  ...
  claims: any[] = [
    {
      ...
      elaboration: 'Die Soziale Arbeit setzt sich beispielsweise in der wirtschaftlichen Sozialhilfe, der Arbeitsintegration ' +
    ...
    },
    {
      ...
      claim: 'Als Fachperson der Sozialen Arbeit analysiere ich individuelle und gesellschaftliche Probleme und suche nach Lösungen.',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: '<b><i>Fachpersonen der Sozialen Arbeit nutzen ihr Wissen und ihre Fähigkeiten dazu, komplexe Probleme zu analysieren und zu lösen.</i></b>'
    },
    {
      competences: 'Kompetenz des methodischen Handelns',
      claim: 'Als Fachperson der Sozialen Arbeit arbeite ich mit unterschiedlichen Methoden und Techniken, welche auf die jeweiligen Arbeitsfelder angepasst sind.',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: '<b><i>Soziale Arbeit verfügt über eine Vielzahl an methodischen Zugängen und Techniken, wie beispielsweise der Gesprächsführung, der Strukturierung von Begleitprozessen usw., welche sie in den unterschiedlichen Arbeitsfeldern einsetzt.</i></b> Im Bachelorstudium (BFH) lernen die Studierenden unterschiedliche Methoden und Techniken kennen und situationsadäquat anzuwenden. '
    },
    {
      competences: 'Sozialrechtliche und sozialadministrative Kompetenz ',
      claim: 'Als Fachperson der Sozialen Arbeit erledige ich auch administrative Tätigkeiten.',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: '<b><i>Unterschiedliche administrative Prozesse sind Teil der Sozialen Arbeit, indem beispielsweise Anträge formuliert, Einschätzungen oder Fallverläufe festgehalten werden.</i></b> Durch die Auseinandersetzung mit den administrativen Gegebenheiten m Rahmen des Studiums (BFH) werden diese verstanden, Ermessenspielräume können aufgezeigt und später in der Praxis genutzt werden.'
    },
    {
      competences: 'Interdisziplinäre Kompetenz',
      claim: 'Als Fachperson der Sozialen Arbeit arbeite ich mit anderen Berufsgruppen zusammen.',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: '<b><i>Soziale Arbeit setzt sich mit komplexen Herausforderungen von Individuen, Gruppen und der Gesellschaft auseinander. Um diesen Herausforderungen bestmöglich zu begegnen, arbeiten Fachpersonen der Sozialen Arbeit in unterschiedlichen Arbeitsfeldern eng mit anderen Berufsgruppen zusammen.</i></b>'
    },
    {
    ...
    },
    {
      ...
      claim: 'Als Fachperson der Sozialen Arbeit arbeite ich auch an Projekten. ',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: 'Die Arbeit in und mit Projekten in der Sozialen Arbeit findet in den unterschiedlichen Arbeitsfeldern statt. <b><i>Projekte werden dabei entweder von den Fachpersonen der Sozialer Arbeit initiiert und durchgeführt, gemeinsam mit den Klient*innen erarbeitet und umgesetzt oder gänzlich durch die Klient*innen gesteuert.</i></b>'
    },
    {
      competences: 'Forschungskompetenz',
      claim: 'Als Fachperson der Sozialen Arbeit, setze ich mich mit Forschung auseinandersetzen.',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: '<b><i>Soziale Arbeit setzt sich mit den Grundlagen von Forschung auseinander, wendet unterschiedliche Forschungsmethoden an und beschäftigt sich mit verschiedenen Forschungszugängen.\n' +
        '\n' +
    ...
    },
    {
      ...
      claim: 'Als Fachperson der Sozialen Arbeit setze ich meine Persönlichkeit als Arbeitsinstrument ein.',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: 'In der Sozialen Arbeit setzen Sie sich als Person als Arbeitsinstrument ein. Die Reflexion der eigenen Persönlichkeit bildet daher einen wichtigen Bestandteil des professionellen Handelns in der Sozialen Arbeit. <b><i>Über die Reflexion beispielsweise ihrer eigenen Werte oder des eigenen Handelns wird die eigene professionelle Rolle analysiert, entwickelt oder weiterentwickelt.</i></b>'
    },
    {
      competences: 'Innovationskompetenz',
      claim: 'Soziale Arbeit ist das Erkennen von Bedürfnissen sowie das Entwickeln von neuen Lösungsansätzen dazu.',
      correctAnswer: 1,
      correctAnswerChecked: false,
      elaboration: '<b><i>Soziale Arbeit ist bestrebt, Bedürfnisse oder Potenziale beispielsweise In einem Spannungsfeld von Individuum und Gesellschaft zu erkennen und mit innovativen Lösungsansätzen darauf zu reagieren, indem sie beispielsweise neue Dienstleistungen entwickelt oder auf aktuelle politische Diskurse reagiert und sich positioniert.</i></b>'
    },
  ];
