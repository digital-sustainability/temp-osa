...
const routes: Route[] = [
  ...
  },
  {
    ...
    data: { animation: 'interest' },
  },
  {
    path: 'current-occupation',
    component: CurrentOccupationComponent,
    data: { animation: 'currentoccupation' },
  },
  {
    path: 'school-type',
    component: SchoolTypeComponent,
    data: { animation: 'schooltype' },
  },
  {
    path: 'personality-trait-scales',
    component: PersonalityTraitScalesComponent,
    data: { animation: 'personality' },
  },
  {
    path: 'self-efficacy-scale',
    component: SelfEfficacyScaleComponent,
    data: { animation: 'selfefficacyscale' },
  },
  {
    path: 'resilience',
    component: ResilienceComponent,
    data: { animation: 'resilience' },
  },
  {
    path: 'empathy',
    component: EmpathyComponent,
    data: { animation: 'empathy' },
  },
  {
    path: 'stereotypes',
    component: StereotypesComponent,
    data: { animation: 'stereotypes' },
  },
  {
    path: 'time-management',
    component: TimeManagementComponent,
    data: { animation: 'timemanagement' },
  },
  {
    path: 'time-management-planner',
    component: TimeManagementPlannerComponent,
    data: { animation: 'timemanagementplanner' },
  },
  {
    path: 'time-management-feedback',
    component: TimeManagementFeedbackComponent,
    data: { animation: 'timemanagementfeedback' },
  },
  {
    path: 'insights',
